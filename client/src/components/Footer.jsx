...
const Footer = () => {
  ...
  return (
    <footer className="w-full flex md:justify-center justify-between items-center flex-col p-4 gradient-bg-footer">
      <section className="w-full flex sm:flex-row flex-col justify-between items-center my-4">
      ...
      <section className="sm:w-[90%] w-full flex justify-between items-center mt-3">
