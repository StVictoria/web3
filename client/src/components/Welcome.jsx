...
const inputs = [
  { id: 1, name: "addressTo", type: "text", placeholder: "Address To" },
  { id: 2, name: "amount", type: "number", placeholder: "Amount (ETH)" },
  { id: 3, name: "keyword", type: "text", placeholder: "Keyword (Gif)" },
  { id: 4, name: "message", type: "text", placeholder: "Enter Message" },
];
...
const Welcome = () => {
  ...
  return (
    <section clasName="flex w-full justify-center items-center">
      <div className="flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start items-start flex-col md:mr-10">
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
            ...
            <div className={commonStyles}>Loww fees</div>
